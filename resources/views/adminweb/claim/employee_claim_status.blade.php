                      ...
                      <tbody>
                          ...
                          <tr>
                              ...
                              <form action = "{{ route('employee.decline_claim', $claim->id)}}" method="POST" >
                                @csrf
                                <button onclick = "Are you sure you want to delete?" type="submit" value="{{$claim->id}}" name="employee_id" class = "btn btn-rounded btn-info mb-5" id = "decline">Decline</button>
                              </form>
                              @endif
                            </td>
                          </tr>
